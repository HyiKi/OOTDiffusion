...
def handler():
    ...
    # args
    model_type = body['model_type'] # "hd" or "dc"
    category = body['category'] # 0:upperbody; 1:lowerbody; 2:dress
    # cloth base64
    cloth_image = body['cloth_img']
    # model base64
    model_image = body['model_img']
    # mask base64
    mask_image = body['mask_img']

    image_scale = body['scale']
    n_steps = body['step']
    n_samples = body['sample']
    seed = body['seed']
